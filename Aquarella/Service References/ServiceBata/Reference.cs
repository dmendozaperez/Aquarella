...
namespace Aquarella.ServiceBata {
    ...
    public interface ws_bataSoap {
        ...
        Aquarella.ServiceBata.ws_envio_xml_desarrolloResponse ws_envio_xml_desarrollo(Aquarella.ServiceBata.ws_envio_xml_desarrolloRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ws_envio_xml_desarrollo", ReplyAction="*")]
        System.Threading.Tasks.Task<Aquarella.ServiceBata.ws_envio_xml_desarrolloResponse> ws_envio_xml_desarrolloAsync(Aquarella.ServiceBata.ws_envio_xml_desarrolloRequest request);
        
        // CODEGEN: Se está generando un contrato de mensaje, ya que el nombre de elemento _archivo_xml del espacio de nombres http://tempuri.org/ no está marcado para aceptar valores nil.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ws_envio_xml", ReplyAction="*")]
        Aquarella.ServiceBata.ws_envio_xmlResponse ws_envio_xml(Aquarella.ServiceBata.ws_envio_xmlRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ws_envio_xml", ReplyAction="*")]
        System.Threading.Tasks.Task<Aquarella.ServiceBata.ws_envio_xmlResponse> ws_envio_xmlAsync(Aquarella.ServiceBata.ws_envio_xmlRequest request);
        ...
        Aquarella.ServiceBata.ws_control_errorResponse ws_control_error(Aquarella.ServiceBata.ws_control_errorRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ws_control_error", ReplyAction="*")]
        System.Threading.Tasks.Task<Aquarella.ServiceBata.ws_control_errorResponse> ws_control_errorAsync(Aquarella.ServiceBata.ws_control_errorRequest request);
    }
    ...
    public partial class ws_envio_xml_desarrolloRequest {
        ...
        public Aquarella.ServiceBata.ws_envio_xml_desarrolloRequestBody Body;
        
        public ws_envio_xml_desarrolloRequest() {
        }
        
        public ws_envio_xml_desarrolloRequest(Aquarella.ServiceBata.ws_envio_xml_desarrolloRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_envio_xml_desarrolloResponse {
        ...
        public Aquarella.ServiceBata.ws_envio_xml_desarrolloResponseBody Body;
        
        public ws_envio_xml_desarrolloResponse() {
        }
        
        public ws_envio_xml_desarrolloResponse(Aquarella.ServiceBata.ws_envio_xml_desarrolloResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_envio_xmlRequest {
        ...
        public Aquarella.ServiceBata.ws_envio_xmlRequestBody Body;
        
        public ws_envio_xmlRequest() {
        }
        
        public ws_envio_xmlRequest(Aquarella.ServiceBata.ws_envio_xmlRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_envio_xmlResponse {
        ...
        public Aquarella.ServiceBata.ws_envio_xmlResponseBody Body;
        
        public ws_envio_xmlResponse() {
        }
        
        public ws_envio_xmlResponse(Aquarella.ServiceBata.ws_envio_xmlResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_control_errorRequest {
        ...
        public Aquarella.ServiceBata.ws_control_errorRequestBody Body;
        
        public ws_control_errorRequest() {
        }
        
        public ws_control_errorRequest(Aquarella.ServiceBata.ws_control_errorRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_control_errorResponse {
        ...
        public Aquarella.ServiceBata.ws_control_errorResponseBody Body;
        
        public ws_control_errorResponse() {
        }
        
        public ws_control_errorResponse(Aquarella.ServiceBata.ws_control_errorResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ws_bataSoapChannel : Aquarella.ServiceBata.ws_bataSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ws_bataSoapClient : System.ServiceModel.ClientBase<Aquarella.ServiceBata.ws_bataSoap>, Aquarella.ServiceBata.ws_bataSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Aquarella.ServiceBata.ws_envio_xml_desarrolloResponse Aquarella.ServiceBata.ws_bataSoap.ws_envio_xml_desarrollo(Aquarella.ServiceBata.ws_envio_xml_desarrolloRequest request) {
            return base.Channel.ws_envio_xml_desarrollo(request);
        }
        
        public string ws_envio_xml_desarrollo(byte[] _archivo_xml, string _name) {
            Aquarella.ServiceBata.ws_envio_xml_desarrolloRequest inValue = new Aquarella.ServiceBata.ws_envio_xml_desarrolloRequest();
            inValue.Body = new Aquarella.ServiceBata.ws_envio_xml_desarrolloRequestBody();
            inValue.Body._archivo_xml = _archivo_xml;
            inValue.Body._name = _name;
            Aquarella.ServiceBata.ws_envio_xml_desarrolloResponse retVal = ((Aquarella.ServiceBata.ws_bataSoap)(this)).ws_envio_xml_desarrollo(inValue);
            return retVal.Body.ws_envio_xml_desarrolloResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Aquarella.ServiceBata.ws_envio_xml_desarrolloResponse> Aquarella.ServiceBata.ws_bataSoap.ws_envio_xml_desarrolloAsync(Aquarella.ServiceBata.ws_envio_xml_desarrolloRequest request) {
            return base.Channel.ws_envio_xml_desarrolloAsync(request);
        }
        
        public System.Threading.Tasks.Task<Aquarella.ServiceBata.ws_envio_xml_desarrolloResponse> ws_envio_xml_desarrolloAsync(byte[] _archivo_xml, string _name) {
            Aquarella.ServiceBata.ws_envio_xml_desarrolloRequest inValue = new Aquarella.ServiceBata.ws_envio_xml_desarrolloRequest();
            inValue.Body = new Aquarella.ServiceBata.ws_envio_xml_desarrolloRequestBody();
            inValue.Body._archivo_xml = _archivo_xml;
            inValue.Body._name = _name;
            return ((Aquarella.ServiceBata.ws_bataSoap)(this)).ws_envio_xml_desarrolloAsync(inValue);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Aquarella.ServiceBata.ws_control_errorResponse Aquarella.ServiceBata.ws_bataSoap.ws_control_error(Aquarella.ServiceBata.ws_control_errorRequest request) {
        ...
        public string ws_control_error(byte[] _archivo, string _cod_tda, string _nom_archivo, string _error) {
            Aquarella.ServiceBata.ws_control_errorRequest inValue = new Aquarella.ServiceBata.ws_control_errorRequest();
            inValue.Body = new Aquarella.ServiceBata.ws_control_errorRequestBody();
            ...
            Aquarella.ServiceBata.ws_control_errorResponse retVal = ((Aquarella.ServiceBata.ws_bataSoap)(this)).ws_control_error(inValue);
            return retVal.Body.ws_control_errorResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Aquarella.ServiceBata.ws_control_errorResponse> Aquarella.ServiceBata.ws_bataSoap.ws_control_errorAsync(Aquarella.ServiceBata.ws_control_errorRequest request) {
            return base.Channel.ws_control_errorAsync(request);
        }
        
        public System.Threading.Tasks.Task<Aquarella.ServiceBata.ws_control_errorResponse> ws_control_errorAsync(byte[] _archivo, string _cod_tda, string _nom_archivo, string _error) {
            Aquarella.ServiceBata.ws_control_errorRequest inValue = new Aquarella.ServiceBata.ws_control_errorRequest();
            inValue.Body = new Aquarella.ServiceBata.ws_control_errorRequestBody();
            inValue.Body._archivo = _archivo;
            inValue.Body._cod_tda = _cod_tda;
            inValue.Body._nom_archivo = _nom_archivo;
            inValue.Body._error = _error;
            return ((Aquarella.ServiceBata.ws_bataSoap)(this)).ws_control_errorAsync(inValue);
        }
    }
}
