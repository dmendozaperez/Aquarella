...
{
    public partial class Principal : Form, Sistema_AQLocal.IPrincipal
    {
        ...
        private bool validainicio()
        {
            ...
            {
                MessageBox.Show("Ingrese el usuario...", Conexion.mensaje, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                valida=false;
                txtusuario.Focus();
                return valida;
            }
            ...
            {
                MessageBox.Show("Ingrese la contraseña...", Conexion.mensaje, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                valida = false;
                txtcontraseña.Focus();
                return valida;
            }
            ...
            try
            {
                ...
                if (user != null)
                {
                    if (user._usu_est_id.Equals(Constantes.IdStatusActive))
                    {
                        ...
                        string cod_tipo = user._usu_tip_id;

                        if (cod_tipo == "04" || cod_tipo == "06" || cod_tipo == "05")
                            ...
                            {
                                MessageBox.Show("Usuario y/o contraseña invalidos.", Conexion.mensaje, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            }
                        else
                        {
                            MessageBox.Show("El Usuario no esta autorizado.", Conexion.mensaje, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        }
                    }
                }
                else
                {
                    MessageBox.Show("Validaccion del usuario fallo.", Conexion.mensaje, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
            }
            catch (Exception exc)
            {
        ...
        private Usuario cargardatos(string nombre)
        {
            ...
            Conexion._bas_id_codigo = Convert.ToInt32(dr["bas_id"].ToString());
        ...
        private void btndguia_Click(object sender, EventArgs e)
        {
            ...
            menu.ActivarFormulario(new Articulo_Stock());
            //menu.ActivarFormulario(frm);
            pnlprincipal.Visible = false;
            lnkinicio.Visible = true;
        ...
        private void btnanulardoc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //menu.ActivarFormulario(new Importar_Data());
                ////menu.ActivarFormulario(frm);
                //pnlprincipal.Visible = false;
                //lnkinicio.Visible = true;
            }
