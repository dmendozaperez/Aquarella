<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Design/Site.Master" CodeBehind="expClientes.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Interface.expClientes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headCPH" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="server">
    Exportar Clientes relacionados con su Lider
</asp:Content>
                        ...
                        <div style="width:50%; padding-left:280px; position:absolute; text-align:right" align="right">
                            <div style="border-left: solid 1px silver;">
                                <asp:ImageButton ID="ibExportDoc" ImageUrl="~/Design/images/Botones/b_doc.png" onmouseover="this.style.background='navy';"
                                    ...
                                    ToolTip="Exportar Archivo de Clientes relacionados con sus lideres " OnClick="ibExportDoc_Click" />
                            </div>
                        </div>
                         <div style="width:100%; text-align:left">Pulse en el boton para exportar los datos<br /> de los Clientes
                            relacionados con sus Lideres: 
                        </div>
                        <br /><br />
                    </div>
                </td>
