<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true"
    CodeBehind="updateProfileForm.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Admonred.updateProfileForm" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function validateBasicInfo() {
           ...
           // bValid = bValid && checkLength(txtPhone, " Telefono", 7, 20);
            ...
            if (txtDoc.val().length== 11) {
                if (dwDocType.val() != '2') {
                    bValid = false;
                    dwDocType.addClass("ui-state-error")
                    updateTips(" El tipo de documento es incorrecto.");
                }
            }

            if (txtDoc.val().length == 8) {
                if (dwDocType.val() == '2') {
                    bValid = false;
                    dwDocType.addClass("ui-state-error")
                    updateTips(" El tipo de documento es incorrecto.");
...
//            }
        ...
        function validateCustomer() {
            ...
            //
            if (dwCustType.val() == "-1" || dwCustType.val() == "") {
                bValid = false;
                dwCustType.addClass("ui-state-error")
                updateTips(" Seleccione tipo de cliente.");
            }
            //
//            if (dwHandlingType.val() == "-1" || dwHandlingType.val() == "") {
//                bValid = false;
//                dwHandlingType.addClass("ui-state-error")
//                updateTips(" Seleccione tipo de flete.");
//            }
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlValidateDoc" runat="server">
        <fieldset>
            <legend class="fsal f13">&nbsp;Validación de documento&nbsp;</legend>
            <p class="f12" style="padding: 5px;">
                Digite el número de documento (sin puntos, comas o espacios) de la persona deseAQUARELLA
                a registrar, para verificar si es un documento libre y se puede proceder</p>
            <table width="100%" cellpadding="6" cellspacing="6">
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btValidateDoc" runat="server" Text="Validar documento" OnClick="btValidateDoc_Click" />
                        &nbsp;</td>
                        <td>
                        <label id="lbltnc">
                                            </label>  
                                <asp:Button ID="btnvalidars" runat="server" 
                                    Style="display: none;" />
                                <button type="button" value="Validar Documento de Identidad (DNI ó Ruc)" id="btnvalida"
                                    title="Validar Documento de Identidad (DNI ó Ruc)" style="display:none">
                                    Validar Documento de Identidad (DNI ó Ruc)</button></td>
                </tr>
            </table>
        </fieldset>
    </asp:Panel>
        ...
        <table cellspacing="6" cellpadding="6" width="100%" border="0">
            ...
            <tr>
                <td width="50%">
                    ...
                    <label for="txtMail">
                        (Ej: fjeremias@manisol.com.co)</label>
                </td>
                <td width="50%">
            ...
            <tr>
                <td>
                 <label for="dwdistrito" class="f12">
                        *Distrito:     </label><asp:UpdatePanel ID="UpdatePanel14" runat="server">
                        <ContentTemplate>
            ...
            <tr>
                <td>
                    <label for="dwArea" class="f12">
                        *Lider, Zona O Area De Influencia:
                    </label>
    ...
    <div style="margin: 10px auto 0 auto;">
        <table width="100%" style="border: 1px solid silver;" cellpadding="4" cellspacing="4"
            ...
            <tr>
                <td align="center">
                    <asp:Button AccessKey="v" ID="btBack" runat="server" Text="(V)olver" ToolTip="Volver"
                ...
                <td align="center">
                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Button ID="btSaveNewProm" runat="server" AccessKey="c" Text="(C)rear promotor"
     ...
     <div id="dialog-valida" title="Validaciones dni o ruc" style="text-align:center">
            <asp:HiddenField ID="hdestado" Value="0" runat="server" />
    <iframe style="border: 0px; " src="Valida_dniruc_reniec.aspx" width="200%" height="200%"></iframe>
</div>    
</asp:Content>
