<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true" CodeBehind="Anular_Pedido_Marcacion.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Logistica.Anular_Pedido_Marcacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="server">
    Anular pedidos en
    Marcación y para facturar en almacen. 
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderPageDesc" runat="server">
    Anulacion de pedidos en marcacion y para facturar en almacen. 
</asp:Content>
                ...
                <div id="fragment-1" style="min-height: 200px;">
                    <table width="100%">
                        <tr>
                            <td>
                                <p>
                                    Pedidos para anular en bodega y envío.</p>
                            </td>                           
                        </tr>
                    </table>
                    ...
                    <asp:UpdatePanel ID="upGridLiqPick" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvLiqPicking" runat="server" SkinID="gridviewSkin" ShowFooter="True"
                                ...
                                OnDataBound="gvLiqPicking_DataBound" OnRowDataBound="gvLiqPicking_RowDataBound"
                                OnRowCommand="gvLiqPicking_RowCommand" 
                                OnRowCreated="gvLiqPicking_RowCreated" AutoGenerateColumns="False" 
                                CellPadding="4" ForeColor="#333333" GridLines="None" Width="1039px">
                                <EditRowStyle BackColor="#2461BF" />
                                <EmptyDataTemplate>
                                    No existen liquidaciones para Anular.
                                </EmptyDataTemplate>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="cantidad" HeaderText="Unds" 
                                        SortExpression="cantidad" ItemStyle-HorizontalAlign="Center" >
                                    <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="Anular" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ibanular"
                                                runat="server" ImageUrl="~/Design/images/b_inactive.png" 
                                                ToolTip="Anular pedido en marcación." CommandArgument='<%# Eval("liq_id")%>' 
                                                CommandName="anularpedido" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                </Columns>
                    ...
                    <asp:ObjectDataSource ID="odsLiqsPick" runat="server" SelectMethod="getLigsPick"
                        TypeName="www.aquarella.com.pe.Aquarella.Logistica.Anular_Pedido_Marcacion"></asp:ObjectDataSource>
