<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true"
    CodeBehind="crearpromotor.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Admonred.crearpromotor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headCPH" runat="server">
    ...
    <%-- <script type="text/javascript">
        var valida;
        $(function () {
            var bnaceptar = $("input[id$='btValidateDoc']");
    ...
    <script type="text/javascript">
        var txtDoc, dwDocType, dwWare, txtFirstName, txtFirstSurname, dwPersonType, txtPhone, txtMovil, txtAddress, txtMail, dwCity, dwArea,
			...
			btSaveNewCust, btUpdateCust, btUpdateProm, btSaveNewProm, btnconsuladni;
    </script>
    ...
    <script type="text/javascript" language="javascript">
        function logica() {
            ...
            btnconsuladni = $("input[id$='btnconsuladni']");
            // Customer
            ...
            btnconsuladni.click(function(){

            })

            //btValidateDoc.click(function () {
            //    var win = $(window);
            //    var dialog = $("#dialog-documento");
            //    var top = (win.height() - dialog.height()) / 2;
            //    var left = (win.width() - dialog.width()) / 2;
            //    //$("#dialog-documento").dialog({ width: 700, height: 380, modal: true, title: 'Verificacion de Documento de Identidad ', open: true, position: "absolute", top: top, left: left });
            //    $("#dialog-documento").dialog({
            //        width: 700,
            //        height: 380,
            //        modal: true,
            //        title: 'Verificacion de Documento de Identidad ',                                        
            //        position: "absolute",
            //        top: top,
            //        left: left,
            //        autoOpen: false,
            //        open: function (type, data) {
            //            $("#dialog-documento").parent().appendTo($("form:first"));
            //        }
            //    });
            //    //$("#dialog-documento").dialog({
            //    //    position: "absolute",
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin: 10px auto 0 auto;">
            ...
            <tr>
                <td align="center">
                    <asp:Button AccessKey="v" ID="btBack" runat="server" Text="(V)olver" ToolTip="Volver"
                        OnClick="btBack_Click" Visible="False" />
                </td>
                <td align="center">
     ...
     <div id="dialog-valida" title="Validaciones dni o ruc" style="text-align:center ;display:none;">
