<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true" CodeBehind="RecalcularStock.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Logistica.RecalcularStock" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headCPH" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="server">
      Recalcular Stock de Articulos 
</asp:Content>
     ...
     <asp:UpdateProgress ID="UpdateProgress1" runat="server">
       ...
       <div style="margin: 10px auto 0 auto;">
        <table width="100%" class="tablaGrisLetra" cellpadding="4">
            <tr>
                <td class="fsal f13">
                    Formulario Recalcular Stock de Articulos
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        <div style="width:50%; padding-left:280px; position:absolute; text-align:right" align="right">
                            <div style="border-left: solid 1px silver;">
                                <asp:ImageButton ID="ibrecalcular" 
                                    ...
                                    ToolTip="Recalcular Stock de Articulos" onclick="ibrecalcular_Click" />
                            </div>
                        </div>
                         <div style="width:100%; text-align:left">Pulse en el boton para recalcular el stock  <br /> de articulos:
                        </div>
                        <br /><br />
                    </div>
                </td>
