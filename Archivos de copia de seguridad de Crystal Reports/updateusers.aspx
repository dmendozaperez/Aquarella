<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Design/Site.Master" CodeBehind="updateusers.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Control.updateusers" %>
    ...
    <asp:Panel ID="pnlValidateDoc" runat="server">
        <fieldset>
            ...
            <p class="f12" style="padding: 5px;">
                Digite el número de documento (sin puntos, comas o espacios) del usuario deseAQUARELLA
            ...
            <tr>
                ...
                <td width="50%">
                    <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                        <ContentTemplate>
                            <asp:Panel ID="panelDwBodegas" Visible="false" runat="server">
                                <label for="dwWare" style="visibility:hidden">
                                    *<u>B</u>odega De Atención :
                                </label>
                                <asp:DropDownList ID="dwWare" DataValueField="wav_warehouseid" DataTextField="wav_description" style="visibility:hidden"
            ...
            <tr>
                <td>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList AccessKey="o" ID="dwArea" runat="server" DataValueField="usu_tip_id"
            ...
            <tr>
                <td width="50%">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList AccessKey="o" ID="dwCustType" runat="server" DataValueField="ctv_coordinator_id"
                                DataTextField="ctv_description" AppendDataBoundItems="True">
                                <asp:ListItem Value="-1">--Seleccionar de la lista--</asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
            ...
            <tr>
                ...
                <td align="center">
                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                        <ContentTemplate>
                            <asp:Button ID="btUpdateCust" runat="server" AccessKey="c" Text="A(c)tualizar usuario"
                            ...
                            <asp:Button ID="btSaveNewProm" runat="server" AccessKey="c" Text="(C)rear usuario"
