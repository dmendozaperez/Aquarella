<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true"
    StylesheetTheme="SiteTheme" CodeBehind="panelAdminPromoters.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Admonred.panelAdminPromoters" %>
                    ...
                    <td>
                        <table width="100%" cellpadding="1" cellspacing="1">
                            <tr>
                                ...
                                <td>
                                    <asp:Button AccessKey="c" ID="btNewCust" runat="server" Text="(C)rear un nuevo promotor"
                                        ToolTip="Cree un nuevo promotor" onclick="btNewCust_Click" />
                                </td>
                            </tr>
                        </table>
                    </td>
