<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true"
    CodeBehind="panelFramesLiqReports.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Logistica.panelFramesLiqReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="server">
    Reporte de liquidación general {AQUARELLA}
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderPageDesc" runat="server">
    Su pedido ya se encuentra liquidado y separado en bodega, recuerde realizar el pago
    del mismo antes del vencimiento del termino de espera pactado.
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin: 10px auto 0 auto;" class="f13">
        ...
        <table width="100%" class="f12" style="border: 1px solid silver; background-color: #f5f5f5;
            ...
            <tr>
                <td align="center">
                    <asp:Button ID="btBack" runat="server" AccessKey="v" Text="(V)olver al panel de pedidos"
                        PostBackUrl="~/Aquarella/Logistica/panelOrdersCustomer.aspx" />
                </td>
            </tr>
        </table>
    </div>
