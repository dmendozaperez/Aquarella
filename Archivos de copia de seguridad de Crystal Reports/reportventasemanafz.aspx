<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true" CodeBehind="reportventasemanafz.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Financiera.reportventasemanafz" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderPageDesc" runat="server">
    Consulte entre un rango de fechas. las ventas
</asp:Content>
                ...
                <asp:GridView ID="gvReturns" runat="server" AllowSorting="True" 
                 ...
                 SkinID="gridviewSkin" PagerStyle-HorizontalAlign="Left" Font-Size="Small" 
                    ...
                    <Columns>
                        ...
                        <ItemStyle BackColor="#FFFF99" HorizontalAlign="Left" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="BolFact" HeaderText="Nro-Doc">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle BackColor="#FFFF99" HorizontalAlign="Center" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="MontoFac" HeaderText="Monto-Doc">
                        <HeaderStyle HorizontalAlign="Right" />
                        <ItemStyle BackColor="#FFFF99" HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="NroVouBcp" HeaderText="Nro-Bcp">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="FECHAVOUBCP" HeaderText="Fecha-Bcp">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="MontoVouBcp" HeaderText="Monto-Bcp">
                        <HeaderStyle HorizontalAlign="Right" />
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="NroVisa" HeaderText="Nro-Visa">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="FECHAVISA" HeaderText="Fecha-Visa">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="MONTOVISA" HeaderText="Monto-Visa">
                        <HeaderStyle HorizontalAlign="Right" />
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="NRONC" HeaderText="Nro-NC">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="FECHANC" HeaderText="Fecha-NC">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="MONTONC" HeaderText="Monto-NC">
                        <HeaderStyle HorizontalAlign="Right" />
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="FECHASALDOANT" HeaderText="Fecha-SaldoAnt">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="MONTOSALDOANT" HeaderText="Monto-SaldoAnt">
                        <HeaderStyle HorizontalAlign="Right" />
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TOTALPAGOS" HeaderText="Total-Pag.">
                        <HeaderStyle HorizontalAlign="Right" />
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="SALDOFAVOR" HeaderText="S.Favor">
                        <HeaderStyle HorizontalAlign="Right" />
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                    </Columns>
