<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true" CodeBehind="reportlider_afiliadoventa.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Ventas.reportlider_afiliadoventa" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderPageDesc" runat="server">
    Consulta Ventas de nuevos lideres X rango de fecha
</asp:Content>
        ...
        <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:GridView ID="gvReturns" runat="server"  BackColor="White" 
                    ...
                    onpageindexchanging="gvReturns_PageIndexChanging" PageSize="18" OnDataBinding="gvReturns_DataBinding">
