...
namespace Sistema_Aquarella
{
    class ReportInvoiceClass
    {
        ...
        public ReportInvoiceClass(String destinatario, String ubicacionDestinatario, String telefono, String celular,
                ...
                String wavDescription, String wavAddress, String wavPhone, String wavUbication, string puntoLlegada, String ubicalugar, string vdireccionf,string vnamelider,String vdirlider)
        {
            //
