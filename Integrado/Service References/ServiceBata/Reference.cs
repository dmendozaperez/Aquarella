...
namespace Integrado.ServiceBata {
    ...
    public interface ws_bataSoap {
        ...
        Integrado.ServiceBata.ws_envio_xml_desarrolloResponse ws_envio_xml_desarrollo(Integrado.ServiceBata.ws_envio_xml_desarrolloRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ws_envio_xml_desarrollo", ReplyAction="*")]
        System.Threading.Tasks.Task<Integrado.ServiceBata.ws_envio_xml_desarrolloResponse> ws_envio_xml_desarrolloAsync(Integrado.ServiceBata.ws_envio_xml_desarrolloRequest request);
        
        // CODEGEN: Se está generando un contrato de mensaje, ya que el nombre de elemento _archivo_xml del espacio de nombres http://tempuri.org/ no está marcado para aceptar valores nil.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ws_envio_xml", ReplyAction="*")]
        Integrado.ServiceBata.ws_envio_xmlResponse ws_envio_xml(Integrado.ServiceBata.ws_envio_xmlRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ws_envio_xml", ReplyAction="*")]
        System.Threading.Tasks.Task<Integrado.ServiceBata.ws_envio_xmlResponse> ws_envio_xmlAsync(Integrado.ServiceBata.ws_envio_xmlRequest request);
        ...
        Integrado.ServiceBata.ws_control_errorResponse ws_control_error(Integrado.ServiceBata.ws_control_errorRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ws_control_error", ReplyAction="*")]
        System.Threading.Tasks.Task<Integrado.ServiceBata.ws_control_errorResponse> ws_control_errorAsync(Integrado.ServiceBata.ws_control_errorRequest request);
    }
    ...
    public partial class ws_envio_xml_desarrolloRequest {
        ...
        public Integrado.ServiceBata.ws_envio_xml_desarrolloRequestBody Body;
        
        public ws_envio_xml_desarrolloRequest() {
        }
        
        public ws_envio_xml_desarrolloRequest(Integrado.ServiceBata.ws_envio_xml_desarrolloRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_envio_xml_desarrolloResponse {
        ...
        public Integrado.ServiceBata.ws_envio_xml_desarrolloResponseBody Body;
        
        public ws_envio_xml_desarrolloResponse() {
        }
        
        public ws_envio_xml_desarrolloResponse(Integrado.ServiceBata.ws_envio_xml_desarrolloResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_envio_xmlRequest {
        ...
        public Integrado.ServiceBata.ws_envio_xmlRequestBody Body;
        
        public ws_envio_xmlRequest() {
        }
        
        public ws_envio_xmlRequest(Integrado.ServiceBata.ws_envio_xmlRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_envio_xmlResponse {
        ...
        public Integrado.ServiceBata.ws_envio_xmlResponseBody Body;
        
        public ws_envio_xmlResponse() {
        }
        
        public ws_envio_xmlResponse(Integrado.ServiceBata.ws_envio_xmlResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_control_errorRequest {
        ...
        public Integrado.ServiceBata.ws_control_errorRequestBody Body;
        
        public ws_control_errorRequest() {
        }
        
        public ws_control_errorRequest(Integrado.ServiceBata.ws_control_errorRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ws_control_errorResponse {
        ...
        public Integrado.ServiceBata.ws_control_errorResponseBody Body;
        
        public ws_control_errorResponse() {
        }
        
        public ws_control_errorResponse(Integrado.ServiceBata.ws_control_errorResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ws_bataSoapChannel : Integrado.ServiceBata.ws_bataSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ws_bataSoapClient : System.ServiceModel.ClientBase<Integrado.ServiceBata.ws_bataSoap>, Integrado.ServiceBata.ws_bataSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Integrado.ServiceBata.ws_envio_xml_desarrolloResponse Integrado.ServiceBata.ws_bataSoap.ws_envio_xml_desarrollo(Integrado.ServiceBata.ws_envio_xml_desarrolloRequest request) {
            return base.Channel.ws_envio_xml_desarrollo(request);
        }
        
        public string ws_envio_xml_desarrollo(byte[] _archivo_xml, string _name) {
            Integrado.ServiceBata.ws_envio_xml_desarrolloRequest inValue = new Integrado.ServiceBata.ws_envio_xml_desarrolloRequest();
            inValue.Body = new Integrado.ServiceBata.ws_envio_xml_desarrolloRequestBody();
            inValue.Body._archivo_xml = _archivo_xml;
            inValue.Body._name = _name;
            Integrado.ServiceBata.ws_envio_xml_desarrolloResponse retVal = ((Integrado.ServiceBata.ws_bataSoap)(this)).ws_envio_xml_desarrollo(inValue);
            return retVal.Body.ws_envio_xml_desarrolloResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Integrado.ServiceBata.ws_envio_xml_desarrolloResponse> Integrado.ServiceBata.ws_bataSoap.ws_envio_xml_desarrolloAsync(Integrado.ServiceBata.ws_envio_xml_desarrolloRequest request) {
            return base.Channel.ws_envio_xml_desarrolloAsync(request);
        }
        
        public System.Threading.Tasks.Task<Integrado.ServiceBata.ws_envio_xml_desarrolloResponse> ws_envio_xml_desarrolloAsync(byte[] _archivo_xml, string _name) {
            Integrado.ServiceBata.ws_envio_xml_desarrolloRequest inValue = new Integrado.ServiceBata.ws_envio_xml_desarrolloRequest();
            inValue.Body = new Integrado.ServiceBata.ws_envio_xml_desarrolloRequestBody();
            inValue.Body._archivo_xml = _archivo_xml;
            inValue.Body._name = _name;
            return ((Integrado.ServiceBata.ws_bataSoap)(this)).ws_envio_xml_desarrolloAsync(inValue);
        }
