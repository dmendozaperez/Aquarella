...
{
    public partial class crearpromotor : System.Web.UI.Page
    {
        Users _user;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.Params["opc"] != null)
                {
                    ...
                    {
                        formUpdateProm(string.Empty, Convert.ToDecimal(Session[_nameSessionIdPromotor]));
                    ...
                    //CargarImagen();
                    lblTitle.Text = "Creación de un nuevo cliente";

                initDws();
                btSaveNewCust.Visible = false;
                dwCustType.Enabled = false;
                txtDoc.Focus();
        ...
        private void CargarImagen()
        {
            ...
            try
            {
                ...
                Byte[] _image = (Byte[])Session["ImageBytes"];
                string base64String = Convert.ToBase64String(_image, 0, _image.Length);

                //pictureCapcha.ImageUrl = "data:image/png;base64," + base64String;
                //pictureCapcha.ImageUrl = "ImageHandler.ashx";
                //pictureCapcha.DataBind();
        ...
        protected void initDws()
        {
            ...
            try
            {
                dsInfoNewCust = Basic_Data.getInfoNewCust();
            }
            catch
            {
        ...
        /// <param name="noDoc"></param>
        /// <param name="idPers"></param>
        protected void formUpdateProm(string noDoc, decimal idPers)
        {
            DataTable dtPerson;
            string showDivs = "$('#fsBasicData').show();$('#fsTypePerson').show();$('#fsUbi').show();$('#fsInfoCust').show();";
            try
            ...
            if (dtPerson != null && dtPerson.Rows.Count > 0)
            {
                ...
                printInfo(infoPerson);
                // Promotor                
                string stProm = infoPerson["prv_status"].ToString();
        ...
        {
            txtDoc.Text = infoPerson["Bas_Documento"].ToString();
            // Tipo documento
            ...
            dwCustType.SelectedValue = infoPerson["Usu_Tip_Id"].ToString();
            // Dirección
        ...
        protected void cleanInfo(string typeForm,Boolean valor=false)
        {
            ...
            if (typeForm.Equals(_formCreCust))
                //if (_user._usv_employee)
                    //if (string.IsNullOrEmpty(_user._usv_warehouse) || _user._usv_warehouse.Equals("%%") || _user._usv_area.Equals("%%"))
        ...
        {
            Response.Redirect("panelAdminPromoters.aspx");
        }
        ...
        public void actionToSave(string typeAction)
        {
            ...
            string usuario_tipo = dwCustType.SelectedItem.Value;
            ...
            if (typeAction.Equals(_formUpdCust))
            {
                ...
                try
                {
                    ...
                    string respuesta = Basic_Data.updateBasicDatausers(cust._usn_userid, primerNombre, segundoNombre, primerApellido, segApellido, fechaNacimiento, tipoDoc, tipoPersona, direccion,
                                                                     telefono, fax, celular, mail, area, User, sexo, ciudad, usuario_tipo,false,agencia,destino, agencia_ruc);
                  ...
                  //  Users.createUserCustomer(_user._usv_co, Convert.ToDecimal(cust._usn_userid), mail, Cryptographic.encrypt(cedula));
            ...
            // Create customer
            else if (typeAction.Equals(_formCreCust))
            {
                //string tipoDePago = "3";
                ///
                ...
                try
                {
                    ...
                    string resp = Basic_Data.crear_usuario(primerNombre, segundoNombre, primerApellido, segApellido, fechaNacimiento, cedula, tipoDoc, tipoPersona, direccion, telefono, fax,
                        celular, mail, area, User, sexo, ciudad, dwCustType.SelectedValue, Cryptographic.encrypt(cedula),1,false,agencia,destino, agencia_ruc);

                    //string resp = Coordinator.addCoordinador(_user._usv_co, primerNombre, segundoNombre, primerApellido, segApellido,
                    //                   fechaNacimiento, cedula, "", tipoDoc, tipoPersona, direccion, telefono, fax,
                    ...
                    //Users.createUserCustomer(_user._usv_co, Convert.ToDecimal(resp), mail, Cryptographic.encrypt(cedula));
                    //
                    msnMessage.LoadMessage("El nuevo cliente se ha creado correctamente; recuerde que su usuario sera el correo electronico (" + mail
        ...
        private void buscar_documento(string doc, string _codigocaptcha)
        {
            try
            {
                ...
                //myInfo.GetInfo(txtDoc.Text, txtimagen.Text);
