...
CodeBehind="rptVentaLider.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Ventas.rptVentaLider" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="server">
    Consulta de ventas por lider 
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderPageDesc" runat="server">
    Consulte entre un rango de fechas, todas las ventas realizadas por los lideres
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                        ...
                                        <tr>
                                            <td class="style3">
                                                <asp:DropDownList ID="dwCustomers" runat="server" AppendDataBoundItems="true" 
                                                    DataTextField="are_descripcion" DataValueField="are_id" 
    ...
    <tr>
   <td class="style4">
                                                <asp:RadioButton ID="optunidad" runat="server" Checked="True" 
                                                    GroupName="grupo1" Text="Unidad" />
                                            </td>
   <td class="auto-style1">
                                                <asp:RadioButton ID="optmonto" runat="server" GroupName="grupo1" Text="Monto" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkresumen" runat="server" Text="Resumido x Lider" Font-Bold="true" Checked="false" AutoPostBack="True" OnCheckedChanged="chkresumen_CheckedChanged" />
                                            </td>
    </tr>
    </table>
    <div style="margin: 10px auto 0 auto;">
        ...
        <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:GridView ID="gvReturns" runat="server"  BackColor="White" 
                    ...
                    Font-Size="Small" Height="327px" Width="1118px" 
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="chkresumen" EventName="CheckedChanged" />
            </Triggers>
        </asp:UpdatePanel>
        <br />
    </div>
