...
{
    public partial class ListaDespachoAlmacen : System.Web.UI.Page
    {
        Users _user;
        ...
        protected void ibExportToExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ExportarExcel(dt, "0", "2", "Lista_Despacho");
        ...
        protected void btncrear_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("DespachoAlmacen.aspx?IdDespacho=0&Descripcion=");
        ...
        protected void gvReturns_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("EditOrder"))
            {
                ...
                Session["estado"] = "2";
                Response.Redirect("EditDespachoAlmacen.aspx?IdDespacho=" + e.CommandArgument.ToString());
            }
