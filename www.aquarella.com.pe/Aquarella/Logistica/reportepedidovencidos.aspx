<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true" CodeBehind="reportepedidovencidos.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Logistica.reportepedidovencidos" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin: 1px 1px 1px 1px;  width: 1078px; overflow: auto;">
            ...
            <ContentTemplate>
                <asp:GridView ID="gvReturns" runat="server" AllowSorting="True" 
                 ...
                 SkinID="gridviewSkin" PagerStyle-HorizontalAlign="Left" Font-Size="Small" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="pedido" HeaderText="Nro Pedido">
                        ...
                        <asp:BoundField DataField="fechapedido" HeaderText="Fec.Pedido">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="fechaven" HeaderText="Fec.Ven">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
        ...
        <asp:ObjectDataSource ID="odsReturns" runat="server" SelectMethod="getconsultapedidoven"
            TypeName="www.aquarella.com.pe.bll.Liquidations_Hdr" OnSelected="odsReturns_Selected">
            <SelectParameters>
