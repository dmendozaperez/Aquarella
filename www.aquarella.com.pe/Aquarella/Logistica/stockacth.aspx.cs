...
{
    public partial class stockacth : System.Web.UI.Page
    {
        Users _user;
        ...
        private void consultar()
        {
            try
            {
                ...
                Session[_nameSessionData] = Stock.get_stockhiguereta(Convert.ToDateTime(txtDateStart.Text), Convert.ToDateTime(txtDateEnd.Text));
        ...
        protected void ibExportToExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string nameFile = "stock_higuereta";
