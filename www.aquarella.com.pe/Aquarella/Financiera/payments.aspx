<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true"
    CodeBehind="payments.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Financiera.payments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headCPH" runat="server">
    ...
    <script type="text/javascript">
        var dwBanks, dwDepositType, txtNoVoucher, txtDate, txtValue, valid, allFields, allFieldsCust, allFieldsBd, isr = ' es requerido.', tips, btSavePay;
    </script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderPageDesc" runat="server">
    Realice el registro de consignaciones realizAQUARELLAs; recuerde que para el uso del monto
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="dwCustomers" DataTextField="Nombres" DataValueField="bas_id"
