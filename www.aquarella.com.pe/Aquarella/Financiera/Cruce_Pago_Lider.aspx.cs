...
{
    public partial class Cruce_Pago_Lider : System.Web.UI.Page
    {
        Users _user;
        ...
        protected void gvClear_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                    ...
                    || decimal.TryParse(DataBinder.Eval(e.Row.DataItem, "von_increase").ToString(), out increase))
                {
                    ...
                    {
                        e.Row.Cells[6].ForeColor = System.Drawing.Color.Salmon;
        ...
        protected void totals()
        {
            try
            {
                ...
                gvClear.FooterRow.Cells[5].Text = grandTotal.ToString(ConfigurationManager.AppSettings["kCurrency"]);
                if (grandTotal + creditValue < 0)
                {
                    gvClear.FooterRow.Cells[6].ForeColor = System.Drawing.Color.Red;
                    imag += "b_inactive.png' />";
                    btCreateClear.Enabled = false;
                }
                else if (grandTotal + creditValue >= 0)
                {
                    gvClear.FooterRow.Cells[6].ForeColor = System.Drawing.Color.White;
                    imag += "b_active.png' />";
                ...
                gvClear.FooterRow.Cells[6].Text = imag;
            }
            catch { }
        }
