<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true" CodeBehind="Saldo_Cliente.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Financiera.Saldo_Cliente" %>
                            ...
                            <tr>
                                ...
                                <td class="style3">
                                    <asp:DropDownList ID="dwCustomers" runat="server" AppendDataBoundItems="true" 
                                        ...
                                        DataValueField="Bas_Id"
                                        ToolTip="Selecionar un Cliente" Width="280px">
                ...
                <asp:GridView ID="gvReturns" runat="server" AllowSorting="True" 
                 ...
                 SkinID="gridviewSkin" PagerStyle-HorizontalAlign="Left" Font-Size="Small" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="dniruc" HeaderText="Dni/Ruc(Promotor)">
                        </asp:BoundField>
                        <asp:BoundField DataField="cliente" HeaderText="Promotor">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                        ...
                        <asp:BoundField DataField="fecha_transac" 
                            HeaderText="Fecha-Transac">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="fecha_doc" HeaderText="Fecha-Doc" >
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
