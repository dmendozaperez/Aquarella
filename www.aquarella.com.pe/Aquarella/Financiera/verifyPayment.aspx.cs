    ...
    public partial class verifyPayment : System.Web.UI.Page
    {
        ...
        protected void gvListPays_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                "confirm('¿Esta seguro de APLICAR el cambio de estado al pago No. " +
                DataBinder.Eval(e.Row.DataItem, "Pag_id") + ", Perteneciente A : -" +
        ...
        protected void loadOds()
        {
            ...
            odsPays.SelectParameters[1].DefaultValue = _user._usv_area;
            ...
            odsStatusPays.SelectParameters[0].DefaultValue = Constants.IdStatusPayments;
            ...
            try
            {
                if (dt != null && dt.Rows.Count > 0)
                {
                    var t = (from x in dt.AsEnumerable()
                             ...
                             {
                                 x1 = y.Count(),
                                 x2 = y.Sum(x => x.Field<decimal>("Pag_Monto"))
                             }).FirstOrDefault();
