    ...
    public partial class updateusers : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //}
                //else
                    lblTitle.Text = "Creación de un nuevo Usuario";
        ...
        public void cargarAreaLiderZonal()
        {
            ...
            {
                dwArea.Items.Clear();
                dsArea = Basic_Data.getInfoNewuserszonal();
        ...
        protected void printInfo(DataRow infoPerson)
        {
           ...
           // if (infoPerson["cov_warehouseid"] != null && !string.IsNullOrEmpty(infoPerson["cov_warehouseid"].ToString()))
            ...
            //
            this.dwArea.SelectedValue = (infoPerson["usu_tip_id"].ToString().Equals(string.Empty)) ? "-1" : infoPerson["usu_tip_id"].ToString();
        }
        ...
        public void actionToSave(string typeAction)
        {
            ...
            if (typeAction.Equals(_formUpdCust))
            {
                ...
                // Bodega 
                //string warehouseId = "1"; // dwWare.SelectedValue;

                try
                {
                    // Realizar procesos de actualizacion de un coordinador
                    string respuesta = Basic_Data.updateBasicDatausers(cust._usn_userid, primerNombre, segundoNombre, primerApellido, segApellido,
                                       fechaNacimiento,tipoDoc,tipoPersona,direccion,telefono,fax,celular,mail,"",User,sexo,ciudad, area);
                    //
            ...
            else if (typeAction.Equals(_formCreProm))
            {
                ...
                try
                {
                    ...
                    //string resp = Coordinator.addNewusers(_user._usv_co, primerNombre, segundoNombre, primerApellido, segApellido,
                    ...
                    ////
                    string resp = Basic_Data.crear_usuario(primerNombre, segundoNombre, primerApellido, segApellido, fechaNacimiento, cedula, tipoDoc, tipoPersona, direccion, telefono,
                                                         fax, celular, mail, "", User, sexo, dwCustType.SelectedValue, area, Cryptographic.encrypt(cedula));
                    msnMessage.LoadMessage("El nuevo usuario se ha creado correctamente; recuerde que su usuario sera el correo electronico (" + mail
