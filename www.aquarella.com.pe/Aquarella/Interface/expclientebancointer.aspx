<%@ Page Title="" Language="C#" MasterPageFile="~/Design/Site.Master" AutoEventWireup="true" CodeBehind="expclientebancointer.aspx.cs" Inherits="www.aquarella.com.pe.Aquarella.Interface.expclientebancointer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headCPH" runat="server">
   
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="server">
      Exportar Clientes-Pedido (BANCO INTERBANK)
</asp:Content>
                ...
                <div style="width:100%">
                    <!-- WARE AND AREA FORM -->
                        ...
                        <div style="width:50%; padding-left:280px; position:absolute; text-align:right" align="right">
                         ...
                         <div style="width:100%; text-align:left">Pulse en el boton para exportar los datos<br /> de los Clientes - pedidos: 
                        </div>
                        <br /><br />
                    </div>
                </td>
