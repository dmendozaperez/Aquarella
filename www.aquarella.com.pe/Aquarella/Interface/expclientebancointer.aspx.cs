...
{
    public partial class expclientebancointer : System.Web.UI.Page
    {
        Users _user;
        ...
        protected void ibExportDoc_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                DataSet _ds = www.aquarella.com.pe.bll.Interfaces.ExpClientesBL.get_cliente_pedido_inter();
                ...
                Response.AddHeader("Content-Disposition", "attachment;filename=C0767903.txt");
