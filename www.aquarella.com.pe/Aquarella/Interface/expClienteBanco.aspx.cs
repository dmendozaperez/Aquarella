...
{
    public partial class expClienteBanco : System.Web.UI.Page
    {
        Users _user;
        ...
        protected void ibExportDoc_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                DataSet _ds = www.aquarella.com.pe.bll.Interfaces.ExpClientesBL.Get_Clientes_Banco();
                ...
                Response.AddHeader("Content-Disposition", "attachment;filename=Clientes_Banco.txt");
